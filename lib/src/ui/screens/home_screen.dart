...
class _HomeState extends State<Home> {
  ...
  void initState() {
    ...
    AppData.data = <DrawerMenuItem>[
      ...
      DrawerMenuItem('Home', Icons.home, <DrawerMenuItem>[
      ...
      ]) : DrawerMenuItem("Home", Icons.home),
      AppConstants.isDemoMode ? DrawerMenuItem('Category', Icons.category, <DrawerMenuItem>[
      ...
      ]) : DrawerMenuItem("Category", Icons.category),
      AppConstants.isDemoMode ? DrawerMenuItem('Shop', Icons.store, <DrawerMenuItem>[
      ...
      ]) : DrawerMenuItem("Shop", Icons.store),
      DrawerMenuItem("My Account", Icons.person),
      DrawerMenuItem("My Orders", Icons.assignment),
      DrawerMenuItem("My Addresses", Icons.location_on),
      ...
      DrawerMenuItem((AppData.user != null) ? "Logout" : "Login", Icons.login)
    ];
  }
  ...
  Map<String, WidgetBuilder> _routeBuilders(BuildContext context, int index) {
    ...
    switch(AppData.settings.homeStyle){
      ...
      case "4":
        ...
        break;
      case "5":
        defaultHomePage = HomePage5(false, _toProductDetailPage, _toShopFromCategory);
        break;
      case "6":
    ...
    return {
      '/': (context) {
        return [
          ...
          Shop(0, "newest", false, _toProductDetailPage),
          News(false),
          Me(mapSelectedItem),
        ].elementAt(index);
      },
